...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>unfiled$public/Recruiting_App_New</template>
    </alerts>
    <fieldUpdates>
...
Unclaimed Positions Queue.</description>
    ...
    <fieldUpdates>
        ...
        <literalValue>Close-Not Filled</literalValue>
...
recruiter if they were created by another type of employee</description>
    ...
    <rules>
        <fullName>Email New Position Alert%2E</fullName>
        <actions>
...
whenever a position record is opened</description>
    ...
    <tasks>
        ...
        <subject>Assign Unclaimed Position Record to</subject>
    </tasks>
</Workflow>
